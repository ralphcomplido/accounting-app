import { ApiResponse, SuccessApiResponse } from "@core/models";
import { catchError, distinctUntilChanged, map, mergeMap, Observable, of, OperatorFunction, switchMap, throwError } from "rxjs";
